...
console.log(JSON.stringify({
  ...
  questionTextTextLayerVerifiedCount: reviewedQuestionCount,
  fourChoicesTextLayerVerifiedCount: reviewedQuestionCount,
  unambiguousChoiceBoundaryCount: reviewedQuestionCount,
  explicitExternalMaterialReferenceDetectedCount: 0,
